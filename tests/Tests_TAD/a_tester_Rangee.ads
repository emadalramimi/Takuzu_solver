...
package A_Tester_Rangee is
   ...
   function Test_Rangee_P8 return Boolean; --8
    function Test_Rangee_P9 return Boolean; --9
   function Test_Rangee_P10 return Boolean; --10
   function Test_Rangee_P11 return Boolean; --11
   function Test_Rangee_P12 return Boolean; --12
  ...
  function Test_Rangee_P23b return Boolean; --26
   ...
   -- tests TAD Rangee
     ...
     ((Test_Rangee_P1'Access,
      ...
      (Test_Rangee_P9'Access,
       To_Unbounded_String ("echec de la propriete 9 Rangee")),      
	   (Test_Rangee_P10'Access,
       To_Unbounded_String ("echec de la propriete 10 Rangee")),      
	   (Test_Rangee_P11'Access,
       To_Unbounded_String ("echec de la propriete 11 Rangee")),      
	   (Test_Rangee_P12'Access,
       To_Unbounded_String ("echec de la propriete 12 Rangee")),
