pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__run_tests_rangee.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__run_tests_rangee.adb");
...
package body ada_main is
   ...
   E137 : Short_Integer; pragma Import (Ada, E137, "chiffre_E");
   E167 : Short_Integer; pragma Import (Ada, E167, "rangee_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "a_tester_rangee_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "a_tester_rangee__finalize_spec");
      begin
         F1;
      end;
      E101 := E101 - 1;
   ...
   begin
      ...
      Rangee'Elab_Spec;
      E167 := E167 + 1;
      A_Tester_Rangee'Elab_Spec;
      A_Tester_Rangee'Elab_Body;
      E005 := E005 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_run_tests_rangee");
...
--  BEGIN Object file/option list
   ...
   --   C:\Users\wette\OneDrive\Documents\BUT\Ada\SAE_1.02\obj\types_tests.o
   --   C:\Users\wette\OneDrive\Documents\BUT\Ada\SAE_1.02\obj\a_tester_Rangee.o
   --   C:\Users\wette\OneDrive\Documents\BUT\Ada\SAE_1.02\obj\run_tests_rangee.o
