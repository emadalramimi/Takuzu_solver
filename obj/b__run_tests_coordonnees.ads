...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_run_tests_coordonnees" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fdfd13d8#;
   pragma Export (C, u00001, "run_tests_coordonneesB");
   u00002 : constant Version_32 := 16#67c8d842#;
   pragma Export (C, u00002, "system__standard_libraryB");
   u00003 : constant Version_32 := 16#5741b5a5#;
   pragma Export (C, u00003, "system__standard_libraryS");
   u00004 : constant Version_32 := 16#d19c2937#;
   pragma Export (C, u00004, "a_tester_coordonneesB");
   u00005 : constant Version_32 := 16#f5cf3aa3#;
   pragma Export (C, u00005, "a_tester_coordonneesS");
   ...
   u00098 : constant Version_32 := 16#c6ca4532#;
   pragma Export (C, u00098, "ada__strings__unboundedB");
   u00099 : constant Version_32 := 16#6552cb60#;
   pragma Export (C, u00099, "ada__strings__unboundedS");
   u00100 : constant Version_32 := 16#144f64ae#;
   ...
   u00109 : constant Version_32 := 16#9ba3f0b5#;
   ...
   u00111 : constant Version_32 := 16#21ac3f0b#;
   pragma Export (C, u00111, "system__address_operationsS");
   u00112 : constant Version_32 := 16#d5d8c501#;
   pragma Export (C, u00112, "system__storage_pools__subpoolsB");
   u00113 : constant Version_32 := 16#e136d7bf#;
   ...
   u00115 : constant Version_32 := 16#31c7c1e8#;
   ...
   u00117 : constant Version_32 := 16#c779f0d3#;
   ...
   u00122 : constant Version_32 := 16#7d52f2a8#;
   ...
   u00124 : constant Version_32 := 16#49d6668f#;
   pragma Export (C, u00124, "system__storage_poolsS");
   u00125 : constant Version_32 := 16#84042202#;
   ...
   u00128 : constant Version_32 := 16#86fcacb5#;
   pragma Export (C, u00128, "system__atomic_countersS");
   u00129 : constant Version_32 := 16#5252521d#;
   pragma Export (C, u00129, "system__stream_attributesB");
   u00130 : constant Version_32 := 16#d573b948#;
   ...
   u00132 : constant Version_32 := 16#2f60cd1f#;
   pragma Export (C, u00132, "system__stream_attributes__xdrS");
   u00133 : constant Version_32 := 16#6ad59d2c#;
   pragma Export (C, u00133, "system__fat_fltS");
   u00134 : constant Version_32 := 16#4ce79421#;
   pragma Export (C, u00134, "system__fat_lfltS");
   u00135 : constant Version_32 := 16#36373acb#;
   pragma Export (C, u00135, "system__fat_llfS");
   u00136 : constant Version_32 := 16#99935d6d#;
   pragma Export (C, u00136, "system__fat_sfltS");
   u00137 : constant Version_32 := 16#b7ead0f4#;
   pragma Export (C, u00137, "coordonneeB");
   u00138 : constant Version_32 := 16#b1b28967#;
   pragma Export (C, u00138, "coordonneeS");
   u00139 : constant Version_32 := 16#a6f36c7e#;
   pragma Export (C, u00139, "types_testsS");
   u00140 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00140, "ada__integer_text_ioB");
   u00141 : constant Version_32 := 16#2ec7c168#;
   pragma Export (C, u00141, "ada__integer_text_ioS");
   u00142 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00142, "ada__text_ioB");
   u00143 : constant Version_32 := 16#03e83e15#;
   ...
   u00148 : constant Version_32 := 16#cf3f1b90#;
   pragma Export (C, u00148, "system__file_control_blockS");
   u00149 : constant Version_32 := 16#fdedfd10#;
   pragma Export (C, u00149, "ada__text_io__integer_auxB");
   u00150 : constant Version_32 := 16#2fe01d89#;
   pragma Export (C, u00150, "ada__text_io__integer_auxS");
   u00151 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00151, "ada__text_io__generic_auxB");
   u00152 : constant Version_32 := 16#305a076a#;
   pragma Export (C, u00152, "ada__text_io__generic_auxS");
   u00153 : constant Version_32 := 16#db42ae56#;
   pragma Export (C, u00153, "system__img_biuB");
   u00154 : constant Version_32 := 16#aa4d7b67#;
   pragma Export (C, u00154, "system__img_biuS");
   u00155 : constant Version_32 := 16#244fa59d#;
   pragma Export (C, u00155, "system__img_llbB");
   u00156 : constant Version_32 := 16#eb8a6b99#;
   ...
   u00159 : constant Version_32 := 16#cd1fde06#;
   pragma Export (C, u00159, "system__img_llwB");
   u00160 : constant Version_32 := 16#42e6480f#;
   pragma Export (C, u00160, "system__img_llwS");
   u00161 : constant Version_32 := 16#811cd12a#;
   pragma Export (C, u00161, "system__img_wiuB");
   u00162 : constant Version_32 := 16#c40cfcf5#;
   pragma Export (C, u00162, "system__img_wiuS");
   u00163 : constant Version_32 := 16#65de8d35#;
   pragma Export (C, u00163, "system__val_intB");
   u00164 : constant Version_32 := 16#875fe85b#;
   pragma Export (C, u00164, "system__val_intS");
   u00165 : constant Version_32 := 16#5276dcb7#;
   pragma Export (C, u00165, "system__val_unsB");
   u00166 : constant Version_32 := 16#59698e93#;
   pragma Export (C, u00166, "system__val_unsS");
   ...
   --  coordonnee%b
   --  types_tests%s
   --  a_tester_coordonnees%s
   --  a_tester_coordonnees%b
   --  run_tests_coordonnees%b
